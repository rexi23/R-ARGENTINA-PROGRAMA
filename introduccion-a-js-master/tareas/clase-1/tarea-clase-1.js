...
function añoYNacimiento (anioActual, anioNacimiento) {
return  anioActual - anioNacimiento 
}

let anioActual = alert("Qué año es hoy?")
let anioNacimiento = alert("En qué año naciste?")

console.log("Ah entonces tenes " + añoYNacimiento(anioActual, anioNacimiento) + " años!")
...
let salario = prompt("Cuanto ganas al año?")
console.log("Entonces ganas " + salario/12 + " pesos mensuales")
