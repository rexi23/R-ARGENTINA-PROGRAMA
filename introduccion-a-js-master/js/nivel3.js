...
tituloss.textContent = "Hola " + nombre + "!"
...
/*
document.querySelector("img").src = "img/gatito.jpeg";
...
nuevoTitulo.style.backgroundColor = "yellow";
...
const elBody = document.querySelector("header");
elBody.appendChild(nuevaImg);

FORMA OPTIMA
*/
const nuevaImg = document.createElement("img");
nuevaImg.src = "img/gatito.jpeg";
